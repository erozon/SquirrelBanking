...
\newpage
\input{texfiles/genesis}
\input{texfiles/generalizations}
\input{texfiles/twotrees}
\input{texfiles/longpregnancy}
\input{texfiles/measure_theory}
\input{texfiles/survival}
\input{texfiles/total_reproductive_output}
\input{texfiles/moran_squirrels}
\input{texfiles/squirrelly_bandits}
\input{texfiles/life_history_discounting}
